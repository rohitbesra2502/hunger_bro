        ...
        <>
            <section className="container mx-auto py-12">
                <div className="flex items-center justify-center flex-col pb-6">
                    <h5 className="uppercase text-red-500 font-semibold text-lg tracking-wider mb-6">Popular  menu </h5>
                    <h2 className="uppercase text-amber-500 text-5xl tracking-wider font mb-6 text-center leading-relaxed">Amazing Food served with delivery </h2>
